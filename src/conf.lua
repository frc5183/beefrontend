function love.conf(t)
    t.identity = "BeeFrontend"                    -- The name of the save directory (string)
    ...
    t.window.title = "Devil Bots BeeAPI Frontend"         -- The window title (string)
    t.window.icon = "asset/png/bee.png"              -- Filepath to an image to use as the window's icon (string)
